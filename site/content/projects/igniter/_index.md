...
<div style="flex: 1; min-width: 35vw; display: flex; justify-content: center;">
  <model-viewer 
      ...
      style="width: 100%; height: 500px; background-color: transparent; position: relative;">
...
{{% box color="blush" %}}
After we conducted sucessful cold flow tests, we conducted hot fire tests to analyze the pressure data and resonant frequency data. Proper safety protocol was followed through Epsilon3 and we were able to get successful ignition. Some tests ended up melting the steel pipe, prompting changes during testing to testing durations, but overall the tests were quite sucessful. 
{{% /box %}}

</div>
</div>

{{< image-gallery images="*.gif" width="20vw" loading="lazy" process="webp" >}}{{< /image-gallery >}}
